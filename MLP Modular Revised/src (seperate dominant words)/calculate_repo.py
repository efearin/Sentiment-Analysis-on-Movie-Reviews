...
def calculate_test(test_df, train_df, train_word_df, w2v_model, dominant_word_df, mlp_model, scaler):
...
def getModelAndScaler (raw_train_feature_datas,raw_train_output_datas):
    ...
    mlpModel = nn.MLPRegressor(activation='identity', early_stopping=True, validation_fraction=0.1)
